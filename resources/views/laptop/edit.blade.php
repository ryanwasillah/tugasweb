	...
	<div class="col-md-6">
			<div class="panel panel-default shadow-lg p-3 mb-5 bg-white rounded" >
			  ...
			  <div class="panel-body mt-3">
			    <form action="/laptop/{{$laptop->id}}/update" class="form-horizontal" method="POST">
				{{csrf_field()}}
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
						<input name="merek" type="text" class="form-control" id="inputMerek" placeholder="Masukan merek" value="{{$laptop->merek}}">
						@if ($errors->has('merek'))             
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
						<input name="tipe" type="text" class="form-control" id="inputTipe" placeholder="Masukan tipe" value="{{$laptop->tipe}}">
						@if ($errors->has('tipe'))             
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<input name="jenis_prosesor" type="text" class="form-control"  placeholder="Masukan jenis prosesor" value="{{$laptop->jenis_prosesor}}">
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<input name="ram" type="text" class="form-control"  placeholder="Masukan besar ram" value="{{$laptop->ram}}">
							@if ($errors->has('ram'))             
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<input name="hardisk" type="text" class="form-control"  placeholder="Masukan besar hardisk" value="{{$laptop->hardisk}}">
					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<input name="harga" type="text" class="form-control"  placeholder="Masukan harga" value="{{$laptop->harga}}">
							@if ($errors->has('harga'))             
